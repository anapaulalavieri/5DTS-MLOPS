...
def assign_persona(cluster):
    ...
    # clusters_result = pd.read_json('C:/Users/anapa/OneDrive/Área de Trabalho/FIAP/15 - Machine Learning Engeneering - MLOPs/MLOPS - Trabalho/Parte 2/clusters_result.json')
...
def predict():
    ...
    # kmeans = joblib.load('C:/Users/anapa/OneDrive/Área de Trabalho/FIAP/15 - Machine Learning Engeneering - MLOPs/MLOPS - Trabalho/Parte 2/kmeans_model.pkl')
    kmeans = joblib.load('./config/kmeans_model.pkl')
    
    # Carregar o scaler
    # scaler = joblib.load('C:/Users/anapa/OneDrive/Área de Trabalho/FIAP/15 - Machine Learning Engeneering - MLOPs/MLOPS - Trabalho/Parte 2/scaler.pkl')
